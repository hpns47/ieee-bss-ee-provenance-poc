...
def fig_a(sweep, out="fig_A_detection_vs_magnitude.png"):
    ...
    ax.set_title("Fig. A: Detection rate vs. attack magnitude\n(Type-2, change_mask parameter tau)")
    ax.set_ylim(-5, 105)
...
def fig_e(bench, out="fig_E_storage_growth.png"):
    ...
    ax.set_ylabel("On-chain storage (KB)")
    ax.set_title("Fig. E: On-chain storage growth\n(O(episodes) scaling)")
    ax.set_xticks([1, 2, 5])
